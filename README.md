...
| Роль | Имя | Вклад |
|------|-----|-------|
| **Аналитик** | [Имя] | Анализ требований, проектирование API, документация, тестирование |
| **Дизайнер** | [Имя] | UI/UX дизайн, прототипирование, адаптивная вёрстка, создание макетов |
| **Разработчик** | [Имя] | Архитектура бэкенда, разработка API, интеграция с PostgreSQL, React-фронтенд |
...
**Вывод:** существующие решения либо слишком общие, либо не поддерживают геймификацию и ролевую модель. Наша платформа — первое специализированное решение для студсоветов с системой бейджей и уровней.
