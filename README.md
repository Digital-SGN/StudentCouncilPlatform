...
## Тема, актуальность, обоснование, анализ аналогов

### Тема проекта
**Платформа для автоматизации работы студенческого совета** с системой учёта активности, мероприятий и цифровых бейджей.
...
|--------|----------------|----------------|
| **Google Forms + Excel** | Бесплатно, просто | Нет автоматизации, нет геймификации, вручную |
| **Vereya (Rusedu)** | Готовая CMS | Перегружена, нет бейджей, не для студсоветов |
| **Miro + Trello** | Визуализация | Не для учёта достижений, нет ролей |
| **StudentLife (зарубежные)** | Интеграция с кампусами | Дорогие, не адаптированы под РФ |
